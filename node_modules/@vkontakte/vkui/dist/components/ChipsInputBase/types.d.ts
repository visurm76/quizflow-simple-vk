 ...
 * @public
 */
export interface ChipsInputBaseProps<O extends ChipOption = ChipOption> extends UseChipsInputBaseOnlyNeededProps<O>, Omit<React.InputHTMLAttributes<HTMLInputElement>, keyof UseChipsInputBaseProps<O> | 'defaultChecked'>, HasRootRef<HTMLDivElement>, HasAlign {
    /**
