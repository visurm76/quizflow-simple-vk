...
export interface FlexItemProps extends Omit<RootComponentProps<HTMLElement>, 'baseClassName'>, HasChildren {
    /**
...
export declare const FlexItem: ({ children, alignSelf, flex, flexBasis, ...rest }: FlexItemProps) => React.ReactNode;
