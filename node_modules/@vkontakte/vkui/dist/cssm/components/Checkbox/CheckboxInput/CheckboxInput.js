...
export function CheckboxInput({ className, style, getRootRef, getRef, indeterminate, defaultIndeterminate, IconOnCompact = Icon20CheckBoxOn, IconOnRegular = Icon24CheckBoxOn, IconOffCompact = Icon20CheckBoxOff, IconOffRegular = Icon24CheckBoxOff, IconIndeterminate = Icon20CheckBoxIndetermanate, slotProps, ...restProps }) {
    const rootRest = useMergeProps({
        className,
        style,
        getRootRef
    }, slotProps?.root);
    const { onChange, getRootRef: getInputRef, ...inputRest } = useMergeProps({
        getRootRef: getRef,
        ...restProps
    }, slotProps?.input);
